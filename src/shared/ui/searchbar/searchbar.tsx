...
export default function SearchBar({ className, ...props }: TSearchBar) {
  ...
  return (
    <div
      className={clsx(
        "flex w-full items-center gap-2 rounded-[10px] bg-zinc-100 px-3 pr-2 text-sm text-zinc-900 hover:bg-zinc-200 focus-visible:bg-zinc-200 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800 dark:focus-visible:bg-zinc-800",
        className,
