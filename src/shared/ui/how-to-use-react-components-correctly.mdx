...
import Ratio from "../ui/ratio/ratio.tsx";
import VideoPlayer from "../ui/video-player/video-player.tsx";
...
<Ratio
  className="overflow-hidden rounded-2xl border border-zinc-200 shadow-md ring-2 ring-zinc-200/50"
  src="/static/assets/storybook/guideline/banner.png"
  alt="Damian Werens - Guideline"
  resolution="4:1"
/>
...
<Grid>
  <VideoPlayer src="https://www.youtube.com/embed/HUBNt18RFbo" />
  <VideoPlayer src="https://www.youtube.com/embed/0aaxLidatlI" />
</Grid>
...
light_url: // path to the thumbnail image in the public folder, remember to create root directory and add two folders: light and dark to there.
dark_url: // path to the thumbnail image in the public folder, remember to create root directory and add two folders: light and dark to there.
...
When you have created the front matter, you can **start writing** the content of the post or project. If you want to add metadata to markdown files, we linked the video below to explain you about benefits of using **frontmatter** in markdown files.

<VideoPlayer src="https://www.youtube.com/embed/kLKgLoGOs1E" />
...
### **3.1. Which the components you can use?**

In the project, we have created **a lot of custom components** that you can use in your markdown files. You can see all components in the **storybook** pages and they were marked as **Markdown**.import Grid from "../ui/grid/grid.tsx";
import Ratio from "../ui/ratio/ratio.tsx";
import VideoPlayer from "../ui/video-player/video-player.tsx";
./grid/grid.tsx./ratio/ratio.tsx./video-player/video-player.tsximport Grid from "../ui/grid/grid.tsx";
import Ratio from "../ui/ratio/ratio.tsx";
import VideoPlayer from "../ui/video-player/video-player.tsx";
