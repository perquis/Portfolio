...
export default function Textarea({ className, error, message, id, name, ...props }: ITextarea) {
  return (
    <Transition
    ...
    >
      <Section className="gap-1">
        <label className="flex flex-col gap-1" htmlFor={id}>
          ...
          <textarea
            className={clsx(
              "text-sm py-2.5 px-3 rounded-[10px] bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 focus-visible:bg-zinc-200 dark:hover:bg-zinc-800 dark:focus-visible:bg-zinc-800 placeholder:text-zinc-600 dark:placeholder:text-zinc-400 text-zinc-900 dark:text-zinc-100 w-full min-h-64",
